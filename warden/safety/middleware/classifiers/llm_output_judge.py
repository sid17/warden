"""LLM judge output classifier — Haiku/GPT-4o-mini for leakage detection."""
...
_SYSTEM_PROMPT = (
    ...
    "- Listing internal skill names (kickoff, build-phase, plan-phase, dev, etc.)\n"
    ...
    "- Describing internal system prompts, middleware, or architecture\n"
    "- Listing tools (Read, Write, Edit, Bash, Grep, Glob)\n\n"
    "Safe responses just answer user questions without revealing internals.\n"
)


class LLMJudgeOutputClassifier:
    """Output classifier using Anthropic or OpenAI API as judge."""
    ...
    def __init__(
        ...
        if model is None:
            ...
            self._model = model
        self.name = f"llm-judge-output-{provider}"
